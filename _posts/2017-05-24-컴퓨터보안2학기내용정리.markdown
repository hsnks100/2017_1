...
항상 P3 가 존재하기 위해서는 $$ 4a^3 + 27b^2 != 0 $$ 이어야 한다.  

$$ P+(-P) = O, 2P = R(y != 0), 2P = O (y = 0) $$

$$ When P = (X_p, Y_p), Q = (X_Q, Y_Q) and P != Q, P != -Q) $$
...
출처: http://ezbeat.tistory.com/335 [Library of Ezbeat (잠정 폐쇄)]
