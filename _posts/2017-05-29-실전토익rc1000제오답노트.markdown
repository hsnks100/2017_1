...
There is some debate as to ____ we should
...
The new edition of the smartphone is ____
on sale in four different colors and three 
different sizes.
...
Gift certificate ____ are refillable via the
...
refillable 과의 조화를 생각해라 좀

The cafeteria, ____ provides inexpensive
...
처참한 감점요소 주의, 미치지 않고서 where v.......................

Jim's Auto Shop used to get a lot of referrals 
from customers, but it hasn't had any ____.
...
Packages that are not addressed with a
specific employee's name will be taken ____
the mail room.
...
Goverment officials support measures to
increase the country's supply of wind power
and reduce ___ on oil from overseas.
...
reliance on
dependability 신뢰도 이런말

as the lead technician was on a brea kwhen
the machinery broke down, no one on the
production floor knew ___ component had
malfunctioned.
